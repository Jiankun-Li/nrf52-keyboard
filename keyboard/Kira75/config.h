...
#define PRODUCT "Kira-75" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t column_pin_array[MATRIX_COLS] =  { 31, 30, 29, 28, 27, 26, 25, 21, 20, 13, 14, 15, 16, 17, 18, 19 };
...
// 旋钮正向按钮映射
#define ROTARY_ENCODER_POS 0,13 // 正向旋转映射到键盘的按键行列
// 旋钮负向按钮映射
#define ROTARY_ENCODER_NEG 0,14 // 负向旋转映射到键盘的按键行列
